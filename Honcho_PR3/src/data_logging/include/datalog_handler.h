...
typedef struct{
	// @@@@ Configurable area SIZE = 144 bytes log @@@@
	
	// 36 x u32 Buckets 0..143
	// 0..39

	uint32_t total_runtime;
	uint32_t laser_level_runtime;
	uint32_t laser_plumb1_runtime;
	uint32_t laser_plumb2_runtime;
	uint32_t vertical_motor_runtime;
	uint32_t yaw_motor_runtime;
	uint32_t ble_connected_time;
	uint32_t time_high_brightness;
	uint32_t time_medium_brightness;
	uint32_t time_low_brightness;
	
	
	
	// 36 x u32 counters 40..123
	uint32_t main_power_switch_in_cycles;
	uint32_t Pendulum_unlock_switch_cycles;
	uint32_t global_brightness_switch_cycles;
	uint32_t laser_1_switch_cycles;
	...
	uint32_t z_rotate_yaw_clockwise_switch;
	uint32_t z_rotate_yaw_counterclockwise_switch;
 	uint32_t global_brightness_remote_switch_cycles;
	uint32_t laser_1_remote_switch_cycles;
	uint32_t laser_2_remote_switch_cycles;
	uint32_t laser_3_remote_switch_cycles;
	uint32_t z_translate_up_remote_switch;
	uint32_t z_translate_down_remote_switch;
	uint32_t z_rotate_yaw_clockwise_remote_switch;
	uint32_t z_rotate_yaw_counterclockwise_remote_switch;
	uint32_t unique_devices_paired_with_unit;
	uint32_t bluetooth_connection_with_unit;
	uint32_t dropped_connections_with_a_paired_device;

	// 20 x u16 faults 124..143
	uint32_t total_count_drops_topples;
	uint32_t shutdown_ntc_hot_pack;
	uint32_t shutdown_battery_undervoltage;
	uint32_t shutdown_8V_buck_upper_limit;
