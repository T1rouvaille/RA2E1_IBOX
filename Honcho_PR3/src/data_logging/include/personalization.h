...
//                        [----------++++++++++----------++++++]
char* g_personalization = "MSL2 04APR HONCHO_Laser M1 20VHE US ";

#define BYTES_CODE_VERSION 4
//                     [----]
char* g_code_version = "v2.0"; 
